...
export default function CaseFilePattern({
  backTo = '/design-system/dashboard',
  workplaceCompareTo = '/app/cases',
}) {
  ...
  return (
    <div className="space-y-6">
      ...
      <p className="text-center text-xs text-slate-500">
        Compare workplace dark case file →{' '}
        <Link to={`${workplaceCompareTo}/${data.id}`} className="text-emerald-300 hover:underline">
          Track B/C at /app
        </Link>
      </p>
    </div>
